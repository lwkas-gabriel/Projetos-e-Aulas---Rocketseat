                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img
                                ...
                                src="https://github.com/lwkas-gabriel.png" alt="" />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Lucas Gabriel</strong>
                                <span className="text-gray-200 text-sm block">Frontend Developer @Rocketseat</span>
                            </div>
                        </div>
                    </div>
